...
if st.session_state.get("user_id"):
    ...
    def call_model(state: State):
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            SystemMessage(
                content=f"You are {state['character']}. Stay fully in character at all times and respond exactly as {state['character']} would. Answer all questions directly, without internal thoughts, explanations, or reasoning—just pure, in-character responses."),
